...
class FAssetTypeActions_DaeTestSuiteActorBlueprint : public FAssetTypeActions_Blueprint
{
public:
    FAssetTypeActions_DaeTestSuiteActorBlueprint(EAssetTypeCategories::Type InAssetTypeCategory);
